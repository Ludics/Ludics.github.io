...
**Structured matrix**: an $m \times n$ matrix can be described using much fewer parameters than $mn$; reducing memory cost & accelerating inference and training stage.
